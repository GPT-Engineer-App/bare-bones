  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      <div className="flex space-x-4">
        <Link to="/counter" className="px-4 py-2 bg-blue-500 text-white rounded">Start Counting</Link>
        <Link to="/settings" className="px-4 py-2 bg-green-500 text-white rounded">Adjust Settings</Link>
      </div>
    </div>
  );
};
